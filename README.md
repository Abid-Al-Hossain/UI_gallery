# UI Foundry Gallery Studio

Standalone visual Gallery generator built with Next.js, React, and TypeScript.

Standalone Gallery component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Gallery UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Gallery generator
...
The editor is focused on controls that are native to Gallery and useful in real product work:
- image count, layout, columns, gap, aspect ratio, caption, overlay, selection, and hover state
- grid, masonry-like, carousel-like, editorial, product, and portfolio gallery variants
- image fit, radius, mask, border, shadow, filter, and overlay styling
- alt/caption intent and meaningful/decorative image guidance
- React export for gallery composition

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Gallery.
...
This repo is intended to publish as Abid-Al-Hossain/UI_gallery.
