...
export type GalleryState = {
  ...
  imageCount: number;
  columns: number;
  aspectRatio: "square" | "16/9" | "4/3" | "portrait";
...
export type StudioPreset = { id: string; family: string; archetype: string; variant: string; size: string; tags: string[]; state: Partial<GalleryState> & Record<string, unknown> };
